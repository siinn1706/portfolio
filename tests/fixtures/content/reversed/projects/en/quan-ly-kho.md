...
The warehouse overview and Items screenshots were captured from the web app running with local FastAPI and SQLite. A demo account displays an empty dataset; 0 and N/A values represent empty or fallback interface states.
