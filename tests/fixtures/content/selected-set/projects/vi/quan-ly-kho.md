...
Ảnh tổng quan kho và danh sách hàng hóa được chụp từ bản web chạy với FastAPI và SQLite cục bộ. Tài khoản demo hiển thị dữ liệu trống; các số 0 và N/A là trạng thái rỗng hoặc fallback của giao diện.
